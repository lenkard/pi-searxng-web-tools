...
def request(query: str, params: "OnlineParams") -> None:
    ...
    # Custom CSE instances may not receive Google domain traits from the loader.
    # The generic CSE endpoint works with www.google.com as the fallback.
    traits.custom.setdefault("supported_domains", {})
