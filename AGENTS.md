...
- Keep Google CSE out of routine defaults. Deployments with provider keys use `zai,serper,bing,yep,mwmbl,wiby`; deployments without them use `bing,yep,mwmbl,wiby`. CSEs remain available for focused searches.
